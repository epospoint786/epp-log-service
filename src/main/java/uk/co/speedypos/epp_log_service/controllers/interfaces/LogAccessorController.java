...
import uk.co.speedypos.epp_log_service.models.response.outgoing.internal.LogOutgoingInternalResponse;
...
public interface LogAccessorController {
     ...
     * Get all logs.
     *
     * @return ResponseEntity List of {@link LogOutgoingInternalResponse}
     * @throws EntityFoundException Thrown when any exception occurs during the handling of get all logs request.
     * @since 1.0
     */
    @RequestMapping
    ResponseEntity<List<LogOutgoingInternalResponse>> getAllLogs() throws EntityFoundException;

    /**
     * Get log by its id.
     *
     * @param id This is the id of the log that is going to be retrieved.
     * @return ResponseEntity {@link LogOutgoingInternalResponse}
     * @throws EntityFoundException Thrown when any exception occurs during the handling of get log by id request.
     * @since 1.0
     */
    @RequestMapping("/{id}")
    ResponseEntity<LogOutgoingInternalResponse> getLogById(@PathVariable Long id) throws EntityFoundException;
